    ...
    <footer className="bg-[#050505] pt-32 pb-10 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="container px-6 mx-auto">
        ...
        <div className="mb-24 text-center">
          ...
          <Link
            href="/contact"
            className="group inline-flex items-center gap-4 md:gap-8"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-0 border-t border-white/5 pt-16 mb-16">
          {/* Column 1 */}
          <div>
            <h4 className="font-mono text-xs text-paper/40 uppercase tracking-widest mb-6">
              {t("sitemap")}
            </h4>
              ...
              {["Works", "Process", "Pricing"].map((item) => (
                <li key={item}>
                  <Link
                    ...
                    className="text-paper/70 hover:text-gold transition-colors font-sans text-sm"
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div className="col-span-2 md:col-span-2 md:text-right">
            <Link
              href="/"
              className="font-serif text-2xl text-paper block mb-4"
            >
